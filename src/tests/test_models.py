...
class TestLearner:
	...
	def test_can_validate_without_skills_should_returns_false(
	...
	def test_add_skill_duplicate_should_raises_value_error(
		self, learner: Learner
	) -> None:
		learner.add_skill(1)
	...
	def test_can_validate_unknown_skill_returns_false(
		self, learner_with_skill: Learner
	) -> None:
...
class TestClassroom:
	...
	def test_merge_keeps_originals_intact(
		self, learner: Learner, trainer: Trainer
	) -> None:
		c1 = Classroom(name='P1')
		c1.add_user(learner)
